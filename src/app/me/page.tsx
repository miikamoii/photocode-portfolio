...
export default function MePage() {
  return (
    <main className="min-h-screen px-4 py-8 sm:px-6 sm:py-12 max-w-3xl mx-auto">
      <h1 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6">About Me</h1>
      ...
      <section className="mb-8 sm:mb-10">
        ...
        <p className="text-gray-600 dark:text-gray-400 ">
          ...
          maintaining aspect ratios. This was a great example of balancing
      ...
      <section>
        <div className="p-4 sm:p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl shadow-md flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold mb-2">My CV</h2>
            <p className="text-gray-600 dark:text-gray-400 ">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-2xl font-medium transition text-sm sm:text-base"
          >
            <svg
